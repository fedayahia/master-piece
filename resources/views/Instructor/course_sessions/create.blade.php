            ...
            <div class="form-group">
                ...
                <div class="radio-group">
                    <div class="radio-option">
                        <input type="radio" id="online" name="session_mode" value="online" {{ old('session_mode') == 'online' ? 'checked' : 'checked' }}>
                        <label for="online">Online</label>
                    </div>
                    <div class="radio-option">
                        <input type="radio" id="offline" name="session_mode" value="offline" {{ old('session_mode') == 'offline' ? 'checked' : '' }}>
